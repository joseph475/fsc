    ...
    //	$pstatus 		= $this->input->post('status');
		...
		//		$checklist->flag_id 		= $crew->flag_id;
			...
			case 20:
				...
				$setting = array_merge((array) $setting, array('data' => $crew, 'paper_size' => 1,  'file_loc' => 'panama/application_for_certificate', 'name' => 'Application_for_Certificate' ));

				break;

			case 21:

				$setting = array_merge((array) $setting, array('data' => $crew, 'paper_size' => 1,  'file_loc' => 'panama/panama_checklist', 'name' => 'panama_checklist' ));		    	
				break;
