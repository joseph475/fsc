		...
		<div class="content">
			...
			<table style="text-align: left;">
				...
				<?php 
					...
					if (in_array($value->docs_id, $docs_id)):
						...
						if($value->docs_id == 13){$pan_booklet = $code; $pan_booklet_expiry = $expiry;}
			...
			<table class="t3" style="text-align: left; border-collapse: collapse;">
				...
				<tr>
					...
					<td class="t3val" style="width: 125px;"><?php echo isset($pan_sso)? $pan_sso : 'N/A'?></td>

					<td class="t3val"  style="width: 140px;">
					...
					<td class="t3val" style="width: 120px; text-align: right;">
				...
				<tr>
					...
					<td class="t3val" style="width: 125px;"><?php echo isset($pan_booklet)? $pan_booklet : 'N/A'?></td>

					<td class="t3val"  style="width: 140px;">
					<p <?php echo (getRemainingDays(isset($pan_booklet_expiry)? $pan_booklet_expiry : '') <= 90)? 'class="alert-expire"' : 'class="normal"' ?>>
					<?php echo isset($pan_booklet_expiry)? $pan_booklet_expiry : ''?></p></td>
				...
				<tr>
					...
					<td class="t3val" style="width: 125px;"><?php echo isset($pan_gmdss)? $pan_gmdss : 'N/A'?></td>
