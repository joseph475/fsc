			...
			<table>
				...
				<tr>
					...
					<td style="width: 35%">
						...
						<span style="font-size: 15px; text-align:left;"><?php echo $pres_tel ?></span></p>
					</td>
				</tr>
			</table>
			...
			<table>
				<tr>
					...
					<td  colspan="2" style="width: 50%">
						...
						<span style="font-size: 15px; text-align:left;"><?php echo $email ?></span></p>
					</td>
				</tr>
			</table>
			...
			<table>
				<tr>
					<td  colspan="4">
						...
						<span style="font-size: 15px; text-align:left;"><?php echo $pos2 . ', ' . $capremarks ?></span></p>
					</td>
				</tr>
			</table>
