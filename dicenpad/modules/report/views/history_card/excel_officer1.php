				...
				<table class="table2" cellpadding="0" cellspacing="0">
					...
					?>			
						<tr>
							...
							<td style="text-align: center;"><?php echo ($date_iss)? $date_iss : ''; ?></td>
							<td style="text-align: center;"><?php echo isset($date_expr)? $date_expr : ''; ?></td>
		...
		<table class="table2" cellpadding="0" cellspacing="0">
			...
			if($work_history):
				...
				foreach ($work_history as $value): 
					...
					$date_iss = (!in_array($value->embarked, $date))? date('m/d/Y', strtotime($value->embarked)) : '';
					$date_end = (!in_array($value->disembarked, $date))? date('m/d/Y', strtotime($value->disembarked)) : '';
			?>
			<tr>
