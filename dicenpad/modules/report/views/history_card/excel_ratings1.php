...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - Excel Ratings History Card</title>
	...
	<div class="flyleaf ">
		...
		<div class="gen_info">
			...
			<div style="page-break-inside: avoid">
				<table class="table2" cellpadding="0" cellspacing="0">
					<tr>
						<th style="border: none;" colspan="6">2. LICENSE (Ratings)</th>
					</tr>
					<tr>
					...
					if($docs_license):
						$docsLicense = array_filter($docs, function($i) {
							return in_array ($i->docs_id , array(8, 13, 9, 15, 97, 16, 10));
						});

						$order = array(8, 13, 9, 15, 97, 16, 10);
						...
						$docs_id = array(8 => 'National COC', 13 => 'Flag Endorse', 9 => 'National GMDSS', 15 => 'Flag Endorse', 
			...
			<div style="page-break-inside: avoid">
				<table class="table2" cellpadding="0" cellspacing="0">
					...
					<?php 
					if($docs_license):
						$docs_id = array(3 => "Passport", 1 => "Seamen's Book (National)", 13 => "Seamen's Book ({$flag})");
					...
					?>			
						<tr>
							...
							<td style="padding-left: 5px;"><?= (_p($arr, 'docs_nos'))? _p($arr, 'docs_nos') : ''; ?></td>
							...
							<td style="text-align: center;"><?php echo isset($arr->remarks)? $arr->remarks : ''; ?></td>
						</tr>
			...
			<div style="page-break-inside: avoid">
				<table class="table2" cellpadding="0" cellspacing="0">
					...
					?>			
						<tr>
							<td><?php echo isset($arr->document)? $arr->document : ''; ?></td>
							<td style="padding-left: 5px; <?= (strlen(_p($arr, 'docs_nos')) > 15)? 'font-size: 8px;' : '' ?>"><?= (_p($arr, 'docs_nos'))? _p($arr, 'docs_nos') : ''; ?></td>
							<td style="text-align: center;"><?php echo isset($date_iss)? $date_iss : ''; ?></td>
							<td style="text-align: center;"><?php echo isset($date_expr)? $date_expr : ''; ?></td>
							<td style="text-align: center;"><?php echo isset($arr->remarks)? $arr->remarks : ''; ?></td>
						</tr>
	...
	<div style="page-break-inside: avoid">
		<table class="table2" cellpadding="0" cellspacing="0">
			...
			if($docs):
				...
				$docs_id = array(142 => 'Drugs and Alcohols', 144 => 'Yellow Fever', 140 => 'Medical Examination', 143 => 'AIDS Test Result');
