...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - ECL Ratings History Card</title>
...
<body>
	...
	<div class="gen_info">
		<table class="table2" cellpadding="0" cellspacing="0">
			<tr>
				<td style="border: none;" colspan="7">Endorsed to:  <strong style="padding-left: 15px; font-family: 'Times New Roman';">EASTERN CAR LINER CO.,  LTD.</strong></td>
		...
		<table class="table2" cellpadding="0" cellspacing="0">
			...
			<?php 
			if($docs_license):
				$docs_id = array(1 => 'SEAMAN\'S BOOK',3 => 'PASSPORT',  10 => 'U.S. VISA');
		...
		<table class="table2" cellpadding="0" cellspacing="0">
			<tr>
				<td style="border: none;" colspan="5">4. PHYSICAL EXAMINATION</td>
			</tr>
			<tr>
				<td style="text-align: center; width: 29%;">Type</td>
				<td style="text-align: center; width: 18%;">Number</td>
		...
		<div style="page-break-inside: avoid">
			<table class="table2" cellpadding="0" cellspacing="0">
				...
				<tr nobr="true">
					...
					<td style="padding-left: 5px; text-align: center;"><?php echo $value->engine;?></td>
