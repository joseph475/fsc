	...
	<div class="gen_info">
		<table class="table2" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td style="width: 18%;" colspan="2"><?php echo date('M d, Y', strtotime($birthdate)); ?></td>
				<td style="width: 9%;">Age</td>
				<td style="width: 27%;" colspan="2"><?php echo get_age(date('Y-m-d', strtotime($birthdate))) . ' y/o'; ?></td>
