		...
		<table style="margin-bottom: 15px;">
			...
			if($docs):
				...
				if($flag == "Japan"){
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,14,15);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,18,19);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,22,23);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,26,27);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,30,31);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,34,35);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10,62,63);
					}
					else{
					...
					if($division =="Officers"){
						$docs_id = array(1, 4, 3, 7,10);
					}
					else{
						$docs_id = array(1, 4, 3, 8,10);			
			  	 	}
