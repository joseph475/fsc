...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - Wave Ratings History Card</title>
	...
	<div class="gen_info">
		...
		<div style="page-break-inside: avoid">
			<table class="table2" cellpadding="0" cellspacing="0">
				...
				<?php 
				if($docs_license):
					$docs_id = array(79 => 'STCW', 65 => 'BASIC SAFETY COURSE', 160 => 'RATINGS FORMING PART OF ENGINEERING WATCH', 70 => 'PREVENTION OF ALCOHOL AND DRUG ABUSE IN MARITIME SECTOR',
									71 => 'MEDICAL EMERGENCY-FIRST AID', 73 => 'ADVANCE FIRE FIGHTING', 74 => 'PROFICIENCY IN SURVIVAL CRAFT/RESCUE BOATS', 76 => 'MARITIME ENGLISH FOR RATINGS',
									80 => 'SHIP SECURITY AWARENESS', 146 => 'SHIP SECURITY AWARENESS TRAINING AND SEAFARERS WITH DESIGNATED SECURITY DUTIES', 156 => 'CONSOLIDATED MARPOL 73/78',
									88 => 'NAC - BASIC SAFETY TRAINING AND INSTRUCTION', 8 => 'CERTIFICATE OF COMPETENCY FOR SEAFARERS');
