...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - Embarkation List</title>
...
<body>
	<div class="header">
		...
		<h4 style="margin-bottom: 15px; text-decoration: underline;">EMBARKATION LIST</h4>
	</div>
	<div class="body">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 26%; text-align: center"><b>Manager's Remark</b></td>
			</tr>
			<?php 
			if($data): 
				$counter = 0;
