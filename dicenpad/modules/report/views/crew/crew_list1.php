...
<body>
	...
	<div class="body">
		<p style="margin-bottom: 10px;">NAME OF VESSEL: <b><?php echo _p($vessel, 'prefix') . ' ' . _p($vessel, 'vessel_name'); ?></b></p>
		...
		<table style="width: 100%; margin-bottom: 5px;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 9%; text_p($vessel, 'prefix') . ' ' . _p($vessel, 'vessel_name')-align: center"><p>Date of Birth</p></td>
			...
			<?php 
				if($principal == "SANTOKU SENPAKU CO., LTD."){
					?>	
						<td style="width: 14%; text-align: center"><p>Last Vessel</p></td>
					<?php
				}
			?>
			...
			<?php 
				if($principal != "SANTOKU SENPAKU CO., LTD."){
					?>	
						<td style="width: 20%; text-align: center"><p>Remarks</p></td>
					<?php
				}
			?>
			...
			?>
				<tr>
					...
					<td style="text-align: center"><p><?php echo date('m/d/Y', strtotime($value->original_date)); ?></p></td>
					<td style="text-align: center"><p><?php echo $value->duration . ' Months'; ?></p></td>

					<?php 
						if($principal == "SANTOKU SENPAKU CO., LTD."){
						?>	
							<td style="text-align: center"><p><?php echo $value->last_vessel?></p></td>
						<?php
						}
					?>
