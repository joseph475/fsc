    ...
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Upload <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <form class="form-search" autocomplete="off">
                        ...
                        <?php if(is_allowed(getclass($clssnme, FALSE, 2))): ?>
                            <a  href="<?php echo site_url('create-upload'); ?>" 
                                class="btn" title="Add" >
                                <i class="icon-plus"></i>
                            </a> 
                        <?php endif; ?>
                        ...
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                ...
                                <th class="sortcolumn" col="id">ID</th>
                                <th>Date Created</th>
                                <th>Actions</th>
                              </tr>
                            </thead>
    ...
    <script id="emp-list-item" type="text/template">  
        ...
        <td>
            <div class="btn-group">
                ...
                <a class="btn record-edit" title="Edit" 
                    href="<?php echo site_url('edit-upload'); ?>/<%= (id)? id : '' %>">                    
                    <i class="icon-edit"></i>
                </a>   
                <?php endif; ?> 
