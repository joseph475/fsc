    ...
    <div class="row-section">     
        ...
        <div class="row-details" id="fileupload">               
            ...
            <?php 
                ...
                echo form_open_multipart('update-memo', $attributes); 
            ?>       
                ...
                <table class="responsive-table" id="options-table-1">
                    <tbody>
                        <tr>
                            ...
                            <td class="ab">
                                <input type="text" id="input_type" placeholder="Type" value="<?php echo isset($type)? $type : ''; ?>" name="type"/>
                                ...
                                <div class="scrollcheck">
                                    ...
                                    if($users){ 
                                        foreach ($users as $value) {
                                            echo "<input type='checkbox' class='idRow' value='{$value->user_id}' name='user[]' " . (in_array($value->user_id, $m_user)?  'checked="checked"' : '') . "> " . strtoupper($value->fullname) . " <br/>";
                                        }
                                    } else {
                        ...
                        <tr>
                            <td><h5>Title</h5></td>
                            <td class="ab">
                                <input type="text" id="input_title" placeholder="Title" value="<?php echo isset($title)? $title : ''; ?>" name="title"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="ab">
                                ...
                                <?php if($filename != '' && !empty($filename)): ?>
                                <a rel='tooltip' title='View Documents' target='_blank' href='<?php echo site_url("uploads/files/{$filename}");?>'>
                                    <h5>View File</h5>
                                </a>
                                <?php endif; ?>
                                <input type="hidden" value="<?php echo isset($filename)? $filename : ''; ?>" name="file_docs"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="ab">
                                <textarea id="elm1" name="description"><?php echo isset($description)? $description : ''; ?></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
