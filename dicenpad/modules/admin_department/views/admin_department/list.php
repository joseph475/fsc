...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  td:nth-of-type(1):before { content: "Department:"; }
...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Admin Department <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                        ...
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                ...
                                <th class="sortcolumn" col="department_code">Code</th>                                
                                <th class="sortcolumn" col="inactive">Published</th>
                                <th>Actions</th>
                              </tr>
                            </thead>
                            <tbody></tbody>                            
    ...
    <script id="emp-list-item" type="text/template">          
        ...
        <td><%= (department_code)? department_code : '' %>&nbsp;</td>        
        <td><%= (inactive == 0)? 'Yes' : 'No' %>&nbsp;</td>
        <td>
            <div class="btn-group">
    ...
    <?php $this->load->view('admin_department/add_admin_department')?>
    <?php $this->load->view('admin_department/edit_admin_department')?>
