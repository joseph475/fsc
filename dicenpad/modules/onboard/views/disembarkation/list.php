...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Disembarkation List <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                    ...
                    <form class="form-search" autocomplete="off">
                        ...
                        <div class="btn-group pull-left" style="margin-right: 5px;">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="report-print" rel="tooltip" title="Export"  href="<?php echo site_url("report/disembarkation-list"); ?>" target="_blank">
                        ...
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                ...
                                <th class="sortcolumn" col="disembarked">Disembark Date</th>
                                <th>Duration</th>
    ...
    <script id="emp-list-item" type="text/template">
        ...
        <td><%= (disembarked)? disembarked : '-' %></td>
        <td><%= (duration)? duration : 0 %></td>
        <td><%= (manager_comment)? manager_comment : '' %></td>
        <td><%= (crew_id)? crew_id : 0 %></td>
    </script>

    <?php $this->load->view('division/add_division')?>
    <?php $this->load->view('division/edit_division')?>
