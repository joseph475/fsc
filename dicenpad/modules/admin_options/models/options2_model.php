...
class options2_model extends MY_Model
{
    ...
    */
    function fetch_all($limit = null, $offset = null, $sort = null, $order = 'desc')
    {
        ...
        $group = array('APPLICATION-STATUS', 'DOCUMENT-CLASSIFICATION', 'PORT', 'REASON', 'TRADE-ROUTE',  'RELIGION',  'EMPLOYMENT-PURPOSES', 'RELATIONSHIP');
        //$this->db->where('deleted', $group);       
