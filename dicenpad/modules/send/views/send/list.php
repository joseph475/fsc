...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  td:nth-of-type(1):before { content: "Date Sent:"; }
  td:nth-of-type(2):before { content: "Vessel:"; }
  td:nth-of-type(3):before { content: "Rank:"; }
  td:nth-of-type(4):before { content: "Crew:"; }
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-1">
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="jd_send.date_sent">Date Sent</th>
                                ...
                                <th>Documents</th>
                                <th>Sent Thru</th>
                                <th class="sortcolumn" col="jd_send.awb_no">AWB No.</th>
                                <th>Actions</th>
                              </tr>
                            </thead>
                            <tbody></tbody>                            
