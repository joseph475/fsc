...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Admin Role <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-1">
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="role">Role</th>
                                <th class="sortcolumn" col="role_code">Code</th>                                
    ...
    <?php $this->load->view('admin_role/add_admin_role')?>
    <?php $this->load->view('admin_role/edit_admin_role')?>
