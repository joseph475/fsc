...
class Salary_model extends MY_Model
{
    ...
    public function _set_join()
    {
        $this->db->select($this->_table_name . '.*, position.code, position.position, 
            ...
            IF((jd_vessels_validity.cba = "IBF-JSU/AMOSUP IMMAJ" OR jd_vessels_validity.cba = "IBF-FJSU/AMOSUP IMMAJ") AND jd_position.division_id = 2, 
            ...
            , jd_vessels_validity.validity_from, jd_vessels_validity.validity_to, jd_vessels_validity.cba
            ',
            FALSE
        );
