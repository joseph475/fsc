...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>flag <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-1">
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="flag">Flag</th>
                                <th class="sortcolumn" col="code">Code</th>                                
                                <th class="sortcolumn" col="published">Inactive</th>
                                <?php if(is_allowed('CRUD')): ?><th>Actions</th><?php endif; ?>
                              </tr>
                            </thead>
                            <tbody></tbody>                            
                        </table>
    ...
    <?php $this->load->view('flag/add_flag')?>
    <?php $this->load->view('flag/edit_flag')?>
