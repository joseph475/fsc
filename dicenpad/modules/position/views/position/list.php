...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Position <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-<?php echo $options_value->id;?>">
                        <table class="responsive-table" id="options-table-<?php echo $options_value->id;?>">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="position">Position</th>
                                <th class="sortcolumn" col="code">Code</th>
                                <th class="sortcolumn" col="division_id">Division</th>                                
                                <th>Published</th>
                                <th>Sort Order</th>
                                <th>Actions</th>
                              </tr>
    ...
    <?php $this->load->view('position/add_position')?>
    <?php $this->load->view('position/edit_position')?>
