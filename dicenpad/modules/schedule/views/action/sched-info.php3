		...
		<table class="responsive-table inoptsinfo" id="options-table-sched">
			<tbody>
				...
				<tr>
					...
					<td><input placeholder="mm/dd/yyyy" style="width:60%;"  type="datetime-local" name="arrival_time" id="arrival_time" value="<?php echo isset($arrival_time)? $arrival_time : ''; ?>" /></td>
				</tr>
			</tbody>
		</table>
