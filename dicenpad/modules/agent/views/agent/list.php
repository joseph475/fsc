...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Agent <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <form class="form-search" autocomplete="off">
                        ...
                        <?php if(is_allowed(getclass($clssnme, FALSE, 2))): ?>
                            ...
                            href="<?php echo site_url() . 'agent-entry'; ?>">
                                <i class="icon-plus"></i>
                            </a> 
                        <?php endif;?>
    ...
    <script id="emp-list-item" type="text/template">          
        <td>
            <a href="<?php echo site_url();?>agent-resume/<%= hash %>"
            data-original-title="<%= (fullname)? fullname : ''  %>">
            <%= (fullname)? fullname : ''  %>
            </a>
        </td>
        <td><%= (principal)? principal : '' %>&nbsp;</td>        
        <td><%= (agent_conctact)? agent_conctact : '' %>&nbsp;</td>
        ...
        <td>
            <div class="btn-group">
                ...
                <a class="btn record-edit" rel="tooltip" title="Edit" 
                    href="<?php echo site_url();?>agent-entry/<%= hash %>">
                    <i class="icon-edit"></i>
                </a>
                <?php endif; ?>
