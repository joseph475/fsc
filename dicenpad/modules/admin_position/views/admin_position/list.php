...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Admin Position <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                        ...
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                ...
                                <th class="sortcolumn" col="position_code">Code</th>                                
    ...
    <script id="emp-list-item" type="text/template">          
        ...
        <td><%= (position_code)? position_code : '' %>&nbsp;</td>        
    ...
    <?php $this->load->view('admin_position/add_admin_position')?>
    <?php $this->load->view('admin_position/edit_admin_position')?>
