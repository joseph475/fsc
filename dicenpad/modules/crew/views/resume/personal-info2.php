	...
	<div class="inopts">
	            ...
	            <select name="report_type" id="report_type">
	            	...
	            	<?php if(!$principal_id): ?>
						...
						<optgroup label="POEA">
							...
							<option value="10"><I></I>nformation Sheet</option>
						</optgroup>
						<optgroup label="RPS">
	    ...
	    <div class="control-group pos1">
	     ...
	     <div class="control-group pos2">
	        ...
	        <div class="controls">
	       	...
	       	<div class="controls" id="endorsedocs" style="margin-top: 5px;">
        ...
        <div class="control-group hiddenField3" id="remarks">
            ...
            <div class="controls">
        		...
        		<?php 
                // if($remarks1){
                //         echo "<input type = 'text' name = 'remarks1' value=''>
                // }
         		?>
            </div>
        </div>
...
<script type="text/javascript">
	function chk_click(){
		if(!document.getElementById('chk_202').checked){
			document.getElementById('chk_202').value = "";
		}
		if(!document.getElementById('chk_203').checked){
			document.getElementById('chk_203').value = "";
		}
		if(!document.getElementById('chk_205').checked){
			document.getElementById('chk_205').value = "";
		}
		if(!document.getElementById('chk_207').checked){
			document.getElementById('chk_207').value = "";
		}
		if(!document.getElementById('chk_208').checked){
			document.getElementById('chk_208').value = "";
		}
		if(!document.getElementById('chk_209').checked){
			document.getElementById('chk_209').value = "";
		}

		if(!document.getElementById('chk_212').checked){
			document.getElementById('chk_212').value = "";
		}
		if(!document.getElementById('chk_235').checked){
			document.getElementById('chk_235').value = "";
		}
 	...
 	function loaddocs(){
	    ...
	    if(pos2 == "MASTER" || pos2 == "FIRST DECK OFFICER"){
	    	<?php
	    		...
	    		?>
	    			val = val + "<input type='checkbox' name='<?php echo $temp_id?>' value='<?php echo $temp_doc?>'?><?php echo $doc?></br>";
	    	...
	    	<?php
	    		...
	    		if (in_array($value->docs_id, $docs_id)):
	    		?>
	    			val = val + "<input type='checkbox' name='<?php echo $temp_id?>' value='<?php echo $temp_doc?>' onclick='chk_click();' ?><?php echo $doc?></br>";
	    			document.getElementById('endorsedocs').innerHTML =  val;
