	...
	<div class="inopts">
	    ...
	    <div class="control-group pos1">
	     ...
	     <div class="control-group pos2">
			...
			<div class="control-group pos2" style="margin-top: 15px;">
		        <label class="control-label" for="capremarks_id">Capacity Remarks :</label>
		        <div class="controls">
		         	<input type="text" name="capremarks_id" placeholder="" value="" /> 
		        </div>
	        </div>
