	...
	<script id="works-edit-template" type="text/template">
	    ...
	    <div class="span-extended2">
	        ...
	        <div class="control-group ">
	            <label class="control-label" for="inputembarked">Embarked : </label>
	            <div class="controls">
	            <% var d = new Date(embarked), fragments = [d.getMonth() + 1, d.getDate(), d.getFullYear() ];  %> 
	            <input type="text" name="embarked" style="width: 80px;" class="ab wdate" placeholder="mm/dd/yyyy" value="<%= (embarked)? fragments.join('/') : '' %>" id="inputembarked" />
	            </div>
	        </div>
	    </div>
	    ...
	    <div class="span-extended2">
	        ...
	        <div class="control-group ">
	            <label class="control-label" for="inputdisembarked">Disembarked : </label>
	            <div class="controls">
	            	<% var d = new Date(disembarked), fragments = [d.getMonth() + 1, d.getDate(), d.getFullYear() ];  %> 
	                <input type="text" name="disembarked" style="width: 80px;" class="ab wdate" placeholder="mm/dd/yyyy" value="<%= (disembarked)? fragments.join('/') : '' %>" id="inputdisembarked" />
	            </div>
	        </div>
	    </div>
