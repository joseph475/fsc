...
<div class="container-fluid" id="options-list-view">
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                 
                    ...
                    <form class="form-search" autocomplete="off">
                        ...
                        <input id="asofdate" class="monthPicker" placeholder="mm/dd/yyyy" type="text" name="asofdate" value="<?= date('m/d/Y') ?>" style="width: 120px;"  />
                    ...
                    <div class="tab-pane fade in " id="status_id-1">
                        ...
                        <table class="responsive-table" id="options-table-1" style="font-size: 10px;">
                            <thead>
                                <tr>
                                    <th>Rank</th>
                                    <th class="sortcolumn" col="fullname" width="25%">Name</th>   
                                    ...
                                    <th id="f1" width="8%"><center id="flag_lic_nos">License/Booklet Nos./<br/>Expiry</center></th>
                                    <th id="f3" width="8%"><center id="flag_gmdss_nos">GMDSS Nos./<br/>Expiry</center></th>
                                    <th><center>PRC/TESDA C.O.C Nos./<br/>Expiry</center></th>
                                    <th><center>U.S Visa Expiry</center></th>
                                    <th><center>Yellow Fever Expiry</center></th>
    ...
    <script id="emp-list-item" type="text/template">   
        ...
        <td><center><%= (passport_nos)? passport_nos : '' %><br/><%= (passport_expiry)? passport_expiry : '' %></center></td>
        <% if (booklet_license != 'N/A' && booklet_license_expiry != 'N/A') { %>
        <td><center><%= (booklet_license)? booklet_license : '' %><br/><%= (booklet_license_expiry)? booklet_license_expiry : '' %></center></td>
        <% }  %>
        <% if (gmdss_nos != 'N/A' && gmdss_expiry != 'N/A') { %>
        <td><center><%= (gmdss_nos)? gmdss_nos : '' %><br/><%= (gmdss_expiry)? gmdss_expiry : '' %></center> </td>
        <% }  %>
        <td><center><%= (coc_nos)? coc_nos : '' %><br/><%= (coc_expiry)? coc_expiry : '' %></center></td>
        <td><center><%= (us_expiry)? us_expiry : '' %></center></td>
        <td><center><%= (yellow_expiry)? yellow_expiry : '' %></center></td>
