...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Sub Type <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                    ...
                    <?php if ($index < 5):?>
                        <li>
                            <a href="#status_id-<?php echo strtolower($options_value->id)?>" 
                                ...
                                rel="tooltip" title="<?php echo strtolower($options_value->title); ?>">
                                <?php echo (strlen($options_value->title) > 20) ? substr($options_value->title,0,20) . '&hellip;' : ucwords(strtoupper($options_value->title));?>
                            </a>
                        </li>
                    <?php ;else:?>
                        <li <?php if ($index == 5): ?> class="dropdown">
                            ...
                            <a href="#status_id-<?php echo strtolower($options_value->id)?>" 
                                ...
                                rel="tooltip" title="<?php echo strtolower($options_value->title);?>"
                                >
                                <?php echo ucwords(strtoupper($options_value->title));?>
                            </a>
                        </li>
    ...
    <?php $this->load->view('type_sub/add_type')?>
    <?php $this->load->view('type_sub/edit_type')?>
