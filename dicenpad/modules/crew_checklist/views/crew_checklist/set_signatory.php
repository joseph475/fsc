<script id="option-set-template" type="text/template">
    <div class="inopts">
        <div class="control-group">
            <label class="control-label" for="check1">Checked By :</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="check2">Approved By :</label>
            <div class="controls">
                <select style="width:70%;" name="check2" id="check2">
                <?php 
                if($signatorys){
                    foreach ($signatorys as $value) {
                        if($value->admin_position_id == 'Approved by'){
                            echo "<option value='{$value->propername}' >{$value->propername}</option>";
                        }
                    }  
                }
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select style="width:70%;" name="company" id="company">
                <?php 
                if($companys){
