...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Search Engine <small>&raquo; Master List</small></h2>
            </div>    
            <div class="row-fluid">
                        ...
                        <table class="responsive-table" id="options-table-<?php echo $options_value->option_id;?>">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sortcolumn" col="jd_position.department_id">Department</th>
                                    <th class="sortcolumn" col="jd_position.division_id">Division</th>
                                    <th>Checklist</th>
    ...
    <script id="emp-list-item" type="text/template">   
        ...
        <td><%= (division)? division : 'No Record' %>&nbsp;</td>>
        <td>
            <div class="btn-group">
                <a class="btn" rel="tooltip" title="Edit" 
                    href="<?php echo site_url('crew-checklist'); ?>/<%= (hash)? hash : '' %>">
                    View 
                </a>     
            </div>
        </td>
