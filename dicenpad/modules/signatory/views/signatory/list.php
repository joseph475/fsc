...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  td:nth-of-type(2):before { content: "Signatory:"; }
...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>Signatory <small>&raquo; Master File</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-1">
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="form_id">Form</th>
                                <th class="sortcolumn" col="lastname">Signatory</th>                                
                                <th class="sortcolumn" col="admin_position_id">Position</th>
                                <th>Published</th>
                                <th>Actions</th>
                              </tr>
                            </thead>
    ...
    <script id="emp-list-item" type="text/template">          
        <td><%= (form_id)? form_id : '' %></td>
        <td><%= (propername)? propername : '' %>&nbsp;</td> 
        <td><%= (admin_position_id)? admin_position_id : '' %>&nbsp;</td> 
    ...
    <?php $this->load->view('signatory/add_signatory')?>
    <?php $this->load->view('signatory/edit_signatory')?>
