                                ...
                                <div class="btn-group pull-left"  style="margin-right: 5px;">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <?php echo ($principal_id == 39 and $this->session->userdata['role_id'] == 10)? form_open('crew-list-report1', 'class="form1D" target="_blank"') :  form_open('crew-list-report', 'class="form1D" target="_blank"'); ?>     
