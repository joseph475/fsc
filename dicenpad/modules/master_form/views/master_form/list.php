...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  td:nth-of-type(1):before { content: "Form:"; }
  td:nth-of-type(2):before { content: "FSC Control Nos.:"; }
  td:nth-of-type(3):before { content: "FSC Remarks:"; }
  td:nth-of-type(4):before { content: "CSI Control Nos.:"; }
  td:nth-of-type(5):before { content: "CSI Remarks:"; }
  td:nth-of-type(6):before { content: "Published:"; }
}
...
<div class="container-fluid" id="options-list-view">
    <div class="row-fluid">    
        <div class="span12">
            <div class="page-header">
                <h2>ISO Master List <small>&raquo; of Forms</small></h2>
            </div>    
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">                    
                    ...
                    <div class="tab-pane fade in" id="status_id-1">
                        <table class="responsive-table" id="options-table-1">
                            <thead>
                              <tr>
                                <th class="sortcolumn" col="title">Form</th>
                                <th>FSC Control Nos</th>      
                                <th>FSC Remarks</th>                  
                                <th>CSI Control Nos</th>      
                                <th>CSI Remarks</th>                           
    ...
    <script id="emp-list-item" type="text/template">          
        ...
        <td><%= (control_nos2)? control_nos2 : '' %>&nbsp;</td>    
        <td><%= (remarks2)? remarks2 : '' %>&nbsp;</td>    
    ...
    <?php $this->load->view('master_form/add_master_form')?>
    <?php $this->load->view('master_form/edit_master_form')?>
