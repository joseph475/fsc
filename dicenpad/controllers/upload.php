...
class Upload extends CI_Controller {
    ...
    protected $path_file_upload_folder;
    ...
    function __construct() {
        ...
        $this->setPath_file_upload_folder("uploads/files/");
    ...
    public function upload_files() {
        ...
        if ($status != "error")
        {
            ...
            //Your upload directory, see CI user guide
            $config['upload_path'] = $this->getPath_file_upload_folder();
      
            $config['allowed_types'] = 'doc|docx|pdf|gif|jpg|png|JPG|GIF|PNG';
           ...
           //Load the upload library
            ...
            if ($this->do_upload()) {
                ...
                echo json_encode(array('status' => $status, 'msg' => $msg, 'name' => $name, 'size' => $size, 'type' => $type));
            }
            else {
               // the display_errors() function wraps error messages in <p> by default and these html chars don't parse in
               // default view on the forum so either set them to blank, or decide how you want them to display.  null is passed.
...
// GETTER & SETTER 
    ...
    public function getPath_file_upload_folder() {
        return $this->path_file_upload_folder;
    }

    public function setPath_file_upload_folder($path_file_upload_folder) {
        $this->path_file_upload_folder = $path_file_upload_folder;
    }
