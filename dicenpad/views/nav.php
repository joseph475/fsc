                    ...
                    <li class="<?php echo ($this->uri->segment(1)=='hr'?'active':'');?> dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Operation <b class="caret visible-desktop"></b></a>
                         <ul class="dropdown-menu visible-desktop">
                            ...
                            <?php if(is_allowed('SCHEDULE_INSERT')): ?>
                            <li><a href="<?php echo site_url('schedule-replacement');?>">Schedule Replacement</a></li>
                            <?php endif; ?>   
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=='hr'?'active':'');?> dropdown">
                        ...
                        <ul class="dropdown-menu visible-desktop">
                            ...
                            <?php if($principal_id): ?>
                             ...
                             <li><a href="<?php echo site_url('schedule-list');?>">Crew Change Slip</a></li>
                                <?php }?>
                             <?php endif; ?>
                            <?php endif;
                            ...
                            <li><a href="<?php echo site_url('expiry-per-documents');?>">Expiry per Document</a></li>
							 <li><a href="<?php echo site_url('report-generator3');?>">OWWA Payment</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
