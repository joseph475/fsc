...
|
*/
$config['rest_realm'] = 'My Secret PTGI API';
...
/*
|--------------------------------------------------------------------------
| Override uat types for specific class/method
|--------------------------------------------------------------------------
|
...
|
*/
$config['auth_override_class_method']['uat_contoller']['login'] = 'digest';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
$config['rest_history_table'] = 'admin_keys_history';
...
|
*/
$config['rest_key_name'] = 'FSC-API-KEY';
