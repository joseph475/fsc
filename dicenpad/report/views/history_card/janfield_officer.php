...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - Janfield Officer History Card</title>
...
<body>
	<div class="header">
		<h4 style="margin: 0;">JANFIELD SHIPPING LIMITED</h4>
		<table>
			<tr>
	...
	<div class="gen_info">
		<table class="table2" cellpadding="0" cellspacing="0">
			<tr>
				<td style="border: none;" colspan="7">Endorsed to:  <b>JANFIELD SHIPPING LIMITED</b></td>
			...
			<tr>
				...
				<td style="width: 18%;" colspan="2"><?php echo date('d-F-Y', strtotime($birthdate)) ?></td>
			...
			<tr>
				...
				<th style="width: 14%;" colspan="2">Clothe Size</th>
				<td style="width: 22%;"><?php echo $clothe_size ?></td>
				<th style="width: 12%;">Shoe Size</th>
		...
		<table class="table2" cellpadding="0" cellspacing="0">
			...
			if($docs_license):
				...
				foreach ($docs_id as $key => $value):
						...
						$date_expr  = ($arr->date_expired)? $arr->date_expired : '';						$arr->document 	 	= $docs_id[$arr->docs_id];
				?>			
					<tr>
