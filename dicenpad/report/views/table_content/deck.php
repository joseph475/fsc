...
<html lang="en">
  <head>
    ...
    <title>FSC Crew Management System - Deck Department</title>
	...
	<style type="text/css">
		...
		@page { margin: 0.4in 0.5in 0.3in 0.5in;}
...
<body>
	<p><?php echo select_iso(12); ?></p>
	<div class="header">
		<h4>TABLE OF CONTENTS</h4>
		<h4>OF DECK DEPARTMENT CREW DOCUMENT</h4>
	</div>
