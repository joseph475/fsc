...
<body>
	...
	<?php endif;?>
	<div class="header">
		<h2 >SCHEDULE FOR CREW REPLACEMENTs</h3>
	</div>
	<div class="body">
		...
		<div style="page-break-inside: avoid">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td style="width: 15%;"><span style="font-size:14px">Terminal: </span></td>
					<td><span style="font-size:14px"> <?php echo ($terminal)? $terminal : '-'; ?></span></td>

					<td style="width: 15%;" ><span style="font-size:14px">Arrival Date: </span></td>
