...
var DirectoryView = Backbone.View.extend({
    ...
    initialize: function () {        
        ...
        if (this.collection.size() == 0) {
            e_model = new Options({fullname: '0', vessel_name: '', remarks: '', position: '', dr: '', de: '', dc: '', receivedfrom: '', document: ''});
    ...
    events: {
        ...
        "change #vessel_id2" : "toggleSearch",
    ...
    toggleSearch: function (e) {
        ...
        this.collection.vessel_id = $('#vessel_id2').val();
